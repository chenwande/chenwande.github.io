"use strict";(self.webpackChunkwonder=self.webpackChunkwonder||[]).push([[863],{99160:function(m,n,e){var u;e.r(n),e.d(n,{demos:function(){return v}});var d=e(90228),_=e.n(d),g=e(87999),p=e.n(g),o=e(75271),a=e(91263),s=e(63120),t=e(34847),r=e.n(t),v={"src-large-file-upload-demo-demo":{component:o.memo(o.lazy(function(){return Promise.all([e.e(847),e.e(433)]).then(e.bind(e,30048))})),asset:{type:"BLOCK",id:"src-large-file-upload-demo-demo",refAtomIds:[],dependencies:{"index.tsx":{type:"FILE",value:e(27486).Z},react:{type:"NPM",value:"18.3.1"},"./utils.ts":{type:"FILE",value:e(71397).Z},"spark-md5":{type:"NPM",value:"3.0.2"}},entry:"index.tsx"},context:{"./utils.ts":s,react:u||(u=e.t(o,2)),"/Users/chenwande/test/wonder/src/large-file-upload/utils.ts":s,"spark-md5":t},renderOpts:{compile:function(){var i=p()(_()().mark(function f(){var h,c=arguments;return _()().wrap(function(l){for(;;)switch(l.prev=l.next){case 0:return l.next=2,e.e(223).then(e.bind(e,61223));case 2:return l.abrupt("return",(h=l.sent).default.apply(h,c));case 3:case"end":return l.stop()}},f)}));function E(){return i.apply(this,arguments)}return E}()}}}},63120:function(m,n,e){e.r(n),e.d(n,{createFileChunks:function(){return _},getFileHash:function(){return g},getFileHashByWebWorker:function(){return p}});var u=e(34847),d=e.n(u),_=function(a){for(var s=arguments.length>1&&arguments[1]!==void 0?arguments[1]:10485760,t=[],r=0;r<a.size;r+=s)t.push(a.slice(r,r+s));return t},g=function(a){return new Promise(function(s){var t=new(d()),r=function v(i){if(i>=a.length){s(t.end());return}var E=a[i],f=new FileReader;f.onload=function(h){var c;if((c=h.target)!==null&&c!==void 0&&c.result){var k=h.target.result;t.append(k),v(i+1)}},f.readAsArrayBuffer(E)};r(0)})},p=function(a){return new Promise(function(s){var t=new Worker(new URL(e.p+e.u(27),e.b),{type:void 0});t.postMessage({chunks:a}),t.onmessage=function(r){s(r.data)}})}},2274:function(m,n,e){e.r(n),e.d(n,{texts:function(){return d}});var u=e(91263);const d=[]},27486:function(m,n){n.Z=`import React, { useState } from 'react';
...
export default Demo;
`},71397:function(m,n){n.Z=`import SparkMd5 from 'spark-md5';
